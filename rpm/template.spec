Name:           ros-hydro-fanuc-lrmate200ic-moveit-config
Version:        0.3.2
Release:        0%{?dist}
Summary:        ROS fanuc_lrmate200ic_moveit_config package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_lrmate200ic_moveit_config
...
%description
MoveIt package for the Fanuc LR Mate 200iC. An automatically generated package
with all the configuration and launch files for using the Fanuc LR Mate 200iC
with the MoveIt Motion Planning Framework. NB: this package currently uses the
