Name:           ros-indigo-fanuc-lrmate200ic-support
Version:        0.4.4
Release:        0%{?dist}
Summary:        ROS fanuc_lrmate200ic_support package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_lrmate200ic_support
...
%description
ROS-Industrial support for the Fanuc LR Mate 200iC (and variants). This package
contains configuration data, 3D models and launch files for Fanuc LR Mate 200iC
manipulators. This includes the base model (/5C, /5WP), /5H, /5L (/5LC), /5F and
the /5HS. Variants in brackets are supported by the files for the referenced
model. Specifications: LR Mate 200iC - &quot;J1 - Normal Range&quot; LR Mate
200iC/5H - &quot;J1 - Normal Range&quot; LR Mate 200iC/5L - &quot;J1 - Normal
Range&quot; LR Mate 200iC/5F - &quot;J1 - Normal Range&quot; Joint limits and
maximum joint velocities are based on the information in the FANUC Robot LR Mate
200iC Mechanical Unit Operator's Manual version B-82584EN/07. All urdfs are
