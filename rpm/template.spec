Name:           ros-indigo-fanuc-m20ia-moveit-config
Version:        0.4.3
Release:        0%{?dist}
Summary:        ROS fanuc_m20ia_moveit_config package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_m20ia_moveit_config
...
%description
MoveIt package for the Fanuc M-20iA. An automatically generated package with
all the configuration and launch files for using the Fanuc M-20iA with the
