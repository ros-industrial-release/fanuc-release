Name:           ros-hydro-fanuc-m16ib20-moveit-config
Version:        0.3.2
Release:        1%{?dist}
Summary:        ROS fanuc_m16ib20_moveit_config package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_m16ib20_moveit_config
...
%description
MoveIt package for the Fanuc M-16iB/20. An automatically generated package with
all the configuration and launch files for using the Fanuc M-16iB/20 with the
MoveIt Motion Planning Framework. NB: this package currently uses the default
MoveIt acceleration limits (ie: 1/5th of joint velocity limits), instead of the
true acceleration limits for this manipulator (see issue 49).
