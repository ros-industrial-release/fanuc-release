Name:           ros-indigo-fanuc-m6ib-support
Version:        0.4.4
Release:        0%{?dist}
Summary:        ROS fanuc_m6ib_support package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_m6ib_support
...
%description
ROS-Industrial support for the Fanuc M-6iB (and variants). This package
contains configuration data, 3D models and launch files for Fanuc M-6iB
manipulators. This currently includes the base model only. Specifications: M-6iB
- Normal Range Joint limits and maximum joint velocities are based on the
information in the FANUC Robot ARC Mate 100i Model B, FANUC Robot M-6i Model B
Maintenance Manual version B-81545EN/01. All urdfs are based on the default
