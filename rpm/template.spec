Name:           ros-indigo-fanuc-lrmate200ib-moveit-config
Version:        0.4.4
Release:        0%{?dist}
Summary:        ROS fanuc_lrmate200ib_moveit_config package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_lrmate200ib_moveit_config
...
%description
MoveIt package for the Fanuc LR Mate 200iB. An automatically generated package
with all the configuration and launch files for using the Fanuc LR Mate 200iB
