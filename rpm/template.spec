Name:           ros-indigo-fanuc-m430ia-moveit-plugins
Version:        0.4.4
Release:        0%{?dist}
Summary:        ROS fanuc_m430ia_moveit_plugins package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_m430ia_moveit_plugins
...
%description
MoveIt plugins for the Fanuc M-430iA (and variants). This package contains
plugins for use with MoveIt and Fanuc M-430iA manipulators. Plugins included
support the 2F and 2P model. See the Fanuc M-430iA support package for
