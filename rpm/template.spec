Name:           ros-hydro-fanuc-lrmate200ic5l-moveit-config
Version:        0.3.2
Release:        0%{?dist}
Summary:        ROS fanuc_lrmate200ic5l_moveit_config package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_lrmate200ic5l_moveit_config
...
%description
MoveIt package for the Fanuc LR Mate 200iC/5L. An automatically generated
package with all the configuration and launch files for using the Fanuc LR Mate
200iC/5L with the MoveIt Motion Planning Framework. NB: this package currently
