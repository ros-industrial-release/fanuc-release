Name:           ros-indigo-fanuc-m16ib-support
Version:        0.4.4
Release:        0%{?dist}
Summary:        ROS fanuc_m16ib_support package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_m16ib_support
...
M-16iB / ARC Mate 120iB manipulators. This currently includes the /20 only.
Specifications: M-16iB/20 - &quot;Default J1 range&quot; Joint limits and
maximum joint velocities are based on the information in the FANUC Robot ARC
Mate 120iB, Fanuc Robot M-16iB/20 Mechanical Unit Maintenance Manual version
B-81765EN/02. All urdfs are based on the default motion and joint velocity
