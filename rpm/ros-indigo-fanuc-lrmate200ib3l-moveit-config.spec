Name:           ros-indigo-fanuc-lrmate200ib3l-moveit-config
Version:        0.4.4
Release:        0%{?dist}
Summary:        ROS fanuc_lrmate200ib3l_moveit_config package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/fanuc_lrmate200ib3l_moveit_config
...
%description
MoveIt package for the Fanuc LR Mate 200iB/3L. An automatically generated
package with all the configuration and launch files for using the Fanuc LR Mate
200iB/3L with the MoveIt Motion Planning Framework. NB: this package currently
